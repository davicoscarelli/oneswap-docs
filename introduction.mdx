...
For devnet integrations:

- create the SDK key from `https://devnet.oneswap.cc/developer/keys`
- initialize the SDK with `environment: 'devnet'`
- the SDK then targets `https://devnet.api.oneswap.cc` by default
